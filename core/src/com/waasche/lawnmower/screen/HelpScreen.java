...
public class HelpScreen extends MenuScreen implements Screen {
    ...
    private void createLayout() {
        ...
        if (isLandscape()) {
            columns = 4;
            this.container.add(this.buttonTutorial).size(Assets.SCREEN_UNIT * 10.0f, Assets.SCREEN_UNIT * 10.0f).pad(Assets.SCREEN_UNIT * 4.0f, Assets.SCREEN_UNIT * 4.0f, 0.0f, 0.0f).align(8);
            this.container.add(new Label(Assets.strings.get("help"), this.skin, "lightSmall")).pad(Assets.SCREEN_UNIT * 4.0f, Assets.SCREEN_UNIT * 2.0f, 0.0f, 0.0f).align(8).expandX();
            this.container.add(new Label(Assets.strings.get("rate"), this.skin, "lightSmall")).pad(Assets.SCREEN_UNIT * 4.0f, 0.0f, 0.0f, Assets.SCREEN_UNIT * 2.0f).align(16).expandX();
            this.container.add(this.buttonRate).size(Assets.SCREEN_UNIT * 10.0f, Assets.SCREEN_UNIT * 10.0f).pad(Assets.SCREEN_UNIT * 4.0f, 0.0f, 0.0f, Assets.SCREEN_UNIT * 4.0f).align(16);
            this.container.row();
        } else {
            columns = 3;
            this.container.add(this.buttonTutorial).size(Assets.SCREEN_UNIT * 10.0f, Assets.SCREEN_UNIT * 10.0f).pad(Assets.SCREEN_UNIT * 4.0f, Assets.SCREEN_UNIT * 4.0f, 0.0f, 0.0f).align(8);
            this.container.add().size(Assets.SCREEN_UNIT * 10.0f, Assets.SCREEN_UNIT * 10.0f).pad(Assets.SCREEN_UNIT * 4.0f, 0.0f, 0.0f, Assets.SCREEN_UNIT * 4.0f);
            this.container.row();
            this.container.add().size(Assets.SCREEN_UNIT * 10.0f, Assets.SCREEN_UNIT * 10.0f).pad(Assets.SCREEN_UNIT * 2.0f, Assets.SCREEN_UNIT * 4.0f, 0.0f, 0.0f);
            this.container.add(this.buttonRate).size(Assets.SCREEN_UNIT * 10.0f, Assets.SCREEN_UNIT * 10.0f).pad(Assets.SCREEN_UNIT * 2.0f, 0.0f, 0.0f, Assets.SCREEN_UNIT * 4.0f).align(16);
            this.container.row();
        }
        float logoWidth = 36.0f * Assets.SCREEN_UNIT;
        ...
        align.pad(f, 0.0f, Assets.SCREEN_UNIT * 2.0f, 0.0f).colspan(columns).expand();
        this.container.row();
        this.container.add(this.logoLibGdx).size(logoWidth, (this.logoLibGdx.getHeight() * logoWidth) / this.logoLibGdx.getWidth()).align(2).padTop(Assets.SCREEN_UNIT * 2.0f).colspan(columns).expand();
        this.container.row();
        this.container.add(this.buttonBack).size(Assets.SCREEN_UNIT * 10.0f, Assets.SCREEN_UNIT * 10.0f).pad(0.0f, Assets.SCREEN_UNIT * 4.0f, Assets.SCREEN_UNIT * 4.0f, 0.0f).align(8).colspan(columns);
    }
}
