...
public class StartScreen  extends MenuScreen implements Screen {
    ...
    private Actor buttonPlay = new Actor();
    ...
    public StartScreen(MainClass mainClass) {
        ...
        this.buttonSettings = new MenuButtonActor(this, this.skin.getDrawable("buttonSettings"), this.SCREEN_UNIT * 10.0f);
    }
    ...
    public void buttonClick(MenuButtonActor button) {
        ...
        if (this.buttonHelp.equals(button)) {
            ...
            Sounds.playButtonClick(0.0f);
        } else if (this.buttonSettings.equals(button)) {
            Sounds.playButtonClick(0.0f);
        }
    }
